...
function SignInPanel() {
  ...
  return (
    <motion.div
      ...
      className="relative w-full max-w-[26rem] overflow-hidden rounded-2xl border border-foreground/12 glass/45 p-7 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.85)] backdrop-blur-2xl"
    >
      {/* top hairline sheen */}
